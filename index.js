...
app.use((req, res, next) => {
    res.setHeader(
        ...
        "default-src 'self'; connect-src 'self' http://localhost:5000 http://localhost:5173 https://studynook000.netlify.app/; img-src 'self' data: https:; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline';"
    );
